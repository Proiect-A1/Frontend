            ...
            {isAuthenticated ? (
              ...
              <>
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border-2 border-pink-400/30 bg-pink-500/10">
                  {/* User avatar circle */}
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-pink-400 to-purple-500 flex items-center justify-center text-[10px] font-bold text-white uppercase">
                    {username?.charAt(0) || "?"}
                  </div>
                  <span className="text-sm font-medium text-pink-200 max-w-[100px] truncate">
                    {username}
                  </span>
                </div>
                <button
