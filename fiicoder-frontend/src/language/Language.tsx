...
export const translations = {
    RO: {
        ...
        newProblems: '100+ Probleme',
        newProblemsDesc: 'De la ușor la concurs, pentru orice nivel de abilitate',
        dailyContests: 'Antrenament Zilnic',
        dailyContestsDesc: 'Rezolvă probleme zilnic și construiește-ți abilitățile',
    ...
    EN: {
        ...
        newProblems: '100+ Problems',
        newProblemsDesc: 'From easy to contest, for every skill level',
        dailyContests: 'Daily Training',
        dailyContestsDesc: 'Solve problems daily and build your skills',
