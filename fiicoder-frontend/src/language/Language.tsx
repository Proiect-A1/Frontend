...
export const translations = {
    RO: {
        ...
        diffCopyPastCode: 'Copiază codul submisiei',
        diffLoadPastCode: 'Încarcă în panoul curent',
        diffApplyToEditor: 'Aplică în editorul principal',
        diffEnableEdit: 'Activează editarea',
        diffDisableEdit: 'Dezactivează editarea',
        diffInlineView: 'Vizualizare inline',
        diffSideBySide: 'Vizualizare alăturată',
        diffEditMode: 'Edit',
    ...
    EN: {
        ...
        diffCopyPastCode: 'Copy submission code',
        diffLoadPastCode: 'Load into current pane',
        diffApplyToEditor: 'Apply to main editor',
        diffEnableEdit: 'Enable editing',
        diffDisableEdit: 'Disable editing',
        diffInlineView: 'Inline view',
        diffSideBySide: 'Side-by-side view',
        diffEditMode: 'Edit',
