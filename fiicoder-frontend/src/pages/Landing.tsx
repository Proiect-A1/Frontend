        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div
                            className={`w-full max-w-lg rounded-2xl border-2 backdrop-blur-lg p-6 md:p-8 shadow-2xl ${
                                announcement.priority === 'high'
                                    ? 'border-red-500/40 bg-red-500/10'
                                    : announcement.priority === 'medium'
                                      ? 'border-pink-500/40 theme-surface-card'
                                      : 'border-pink-500/30 theme-surface-card'
                            }`}
                        >
...
export default function Landing() {
    ...
    return (
        <div className="w-full flex justify-center h-auto xl:h-full">
            <motion.div
                className="w-full max-w-7xl rounded-2xl border-2 border-pink-500/30 theme-surface-card backdrop-blur-lg px-5 py-6 md:px-8 md:py-8 card-glow h-auto overflow-hidden xl:h-full xl:overflow-y-auto custom-scrollbar relative"
