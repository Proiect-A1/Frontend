            ...
            <div className="w-full rounded-2xl px-5 py-6 md:px-8 md:py-8 flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6 mb-10">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div
                                className={`w-10 h-10 rounded-xl ${feature.color} flex items-center justify-center mb-3 group-hover:scale-105 transition-transform duration-300 ${feature.iconColor}`}
                            >
                                {feature.icon}
                            </div>
